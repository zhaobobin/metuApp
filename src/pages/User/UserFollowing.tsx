...
class UserFollowing extends React.Component<IProps, IState> {
  ...
  componentDidMount() {
    this.queryUserFollowing();
  }

  queryUserFollowing = async (loadMore?: boolean) => {
    ...
    const res = await userApi.getUserFollowing({
      user_id,
      page,
      per_page
    });
